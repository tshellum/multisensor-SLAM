...
public:
  ...
  void addPose2Graph(int pose_id, const tf2_msgs::TFMessage& msg, gtsam::NonlinearFactorGraph& graph);
};



void GNSSHandler::addPose2Graph(int pose_id, const tf2_msgs::TFMessage& msg, gtsam::NonlinearFactorGraph& graph)
{
