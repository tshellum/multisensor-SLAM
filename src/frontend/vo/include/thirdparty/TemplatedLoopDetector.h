...
public:
  ...
  vector<cv::KeyPoint> getKeyPointsAtEntry(EntryId id);
  vector<TDescriptor>  getDescriptorsAtEntry(EntryId id);
...
template<class TDescriptor, class F>
vector<cv::KeyPoint> TemplatedLoopDetector<TDescriptor, F>::getKeyPointsAtEntry(EntryId id) 
{
  return m_image_keys[id];
}

// --------------------------------------------------------------------------

template<class TDescriptor, class F>
vector<TDescriptor> TemplatedLoopDetector<TDescriptor, F>::getDescriptorsAtEntry(EntryId id)
{
  return m_image_descriptors[id];
}
